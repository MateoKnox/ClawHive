export const ESCROW_ABI = [
  ...
  'function reputation(address wallet) view returns (uint256)',
  'function tasksAccepted(address wallet) view returns (uint256)',
  'function tasksCompleted(address wallet) view returns (uint256)',
  'function verifierApprovals(address wallet) view returns (uint256)',
  'function getReputationStats(address wallet) view returns (uint256 accepted,uint256 completed,uint256 approvals,uint256 rep)',
